...
- [IP-0010：PR3 类 Artifact(JSON Schema + 兼容矩阵 + ADR)](LIMA_Implementation_Packet_IP-0010_PR3_Artifacts.md) — Packet PR #132、Implementation PR #133 已合并（IP-DONE）
- [IP-0011：V5-FR-04 场景 fixtures(六状态跨 Artifact 组合)](LIMA_Implementation_Packet_IP-0011_Scenario_Fixtures.md) — Packet 与 [正式开发任务交接](LIMA_Coding_Agent_IP-0011_正式开发任务交接.md) 冻结中；实现未开始

IP-0001 至 IP-0010 完成以及 IP-0011 的 Packet 合并都不等于 Source Issue #58 完成。#58 只有在 Delivery Ledger 的全部 mandatory requirements、集成/真实运行和 Issue Closure Audit 均通过后才可手工关闭。
