...
class TaskStore:
    ...
    def _connect(self) -> Iterator[sqlite3.Connection]:
        ...
        ``__exit__`` method does not close the connection.  The store creates a
        connection per operation, so relying on that behavior leaked handles and
        kept database files locked on Windows.
        """
