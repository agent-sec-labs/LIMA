...
from lima.diff_parser import parse_unified_diff  # noqa: E402
from lima.evaluation_harness import validate_case  # noqa: E402
...
def fetch_diff(repository, pull_request, token=""):
    ...
    headers = {
        ...
        "User-Agent": "lima-evaluation-importer",
